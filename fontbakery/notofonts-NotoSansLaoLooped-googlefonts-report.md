...
<details><summary><b>[8] NotoSansLaoLooped[wdth,wght].ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Version number has increased since previous release on Google Fonts? (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/version_bump">com.google.fonts/check/version_bump</a>)</summary><div>
 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: canadian-aboriginal, syriac, tifinagh, old-permic, math, tai-le, malayalam, coptic
 ...
 * U+0E4F THAI CHARACTER FONGMAN: try adding thai
 * U+0E5B THAI CHARACTER KHOMUT: try adding thai
 * U+0ECE LAO YAMAKKAN: not included in any glyphset definition
 * U+200C ZERO WIDTH NON-JOINER: try adding one of: siddham, pahawh-hmong, tagbanwa, kharoshthi, khojki, phags-pa, chakma, tai-viet, khmer, malayalam, nko, rejang, yi, devanagari, sharada, sundanese, tamil, bengali, syriac, gurmukhi, buginese, kayah-li, lepcha, manichaean, tifinagh, tirhuta, avestan, tagalog, warang-citi, hanunoo, telugu, tai-tham, cham, dogra, buhid, hanifi-rohingya, gujarati, sogdian, hatran, balinese, javanese, new-tai-lue, kaithi, psalter-pahlavi, mahajani, mongolian, batak, duployan, modi, mandaic, myanmar, grantha, syloti-nagri, takri, meetei-mayek, khudawadi, tibetan, saurashtra, limbu, gunjala-gondi, oriya, sinhala, thaana, tai-le, newa, kannada, thai, brahmi
 * U+200D ZERO WIDTH JOINER: try adding one of: siddham, pahawh-hmong, tagbanwa, kharoshthi, khojki, phags-pa, chakma, tai-viet, malayalam, nko, rejang, yi, devanagari, sharada, sundanese, tamil, bengali, syriac, gurmukhi, buginese, kayah-li, lepcha, manichaean, tifinagh, tirhuta, avestan, tagalog, warang-citi, hanunoo, telugu, tai-tham, cham, dogra, emoji, buhid, hanifi-rohingya, gujarati, balinese, javanese, new-tai-lue, old-hungarian, kaithi, psalter-pahlavi, mahajani, mongolian, batak, duployan, modi, mandaic, myanmar, grantha, syloti-nagri, takri, meetei-mayek, khudawadi, tibetan, saurashtra, limbu, gunjala-gondi, oriya, sinhala, thaana, tai-le, newa, kannada, thai, brahmi
 * U+2010 HYPHEN: try adding one of: syloti-nagri, cham, kayah-li, sora-sompeng, kharoshthi, lisu, kaithi, yi, coptic, sundanese
 * U+2012 FIGURE DASH: not included in any glyphset definition
 * U+2015 HORIZONTAL BAR: try adding adlam
 * U+2060 WORD JOINER: not included in any glyphset definition
 * U+2638 WHEEL OF DHARMA: try adding one of: emoji, symbols

Or you can add the above codepoints to one of the subsets supported by the font: `lao`, `latin`, `latin-ext` [code: unreachable-subsetting]
...
Your font does *not* cover the following languages that require the soft-dotted feature: Basaa (Latn, 332,940 speakers), Koonzime (Latn, 40,000 speakers), Navajo (Latn, 166,319 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Nateni (Latn, 100,000 speakers), Makaa (Latn, 221,000 speakers), Southern Kisi (Latn, 360,000 speakers), Gulay (Latn, 250,478 speakers), Belarusian (Cyrl, 10,064,517 speakers), Ejagham (Latn, 120,000 speakers), Avokaya (Latn, 100,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Bafut (Latn, 158,146 speakers), Igbo (Latn, 27,823,640 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Lugbara (Latn, 2,200,000 speakers), Cicipu (Latn, 44,000 speakers), Aghem (Latn, 38,843 speakers), Kom (Latn, 360,685 speakers), South Central Banda (Latn, 244,000 speakers), Mfumte (Latn, 79,000 speakers), Nzakara (Latn, 50,000 speakers), Fur (Latn, 1,230,163 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Ekpeye (Latn, 226,000 speakers), Mundani (Latn, 34,000 speakers), Sar (Latn, 500,000 speakers), Zapotec (Latn, 490,000 speakers), Yala (Latn, 200,000 speakers), Dii (Latn, 71,000 speakers), Ma’di (Latn, 584,000 speakers), Dan (Latn, 1,099,244 speakers), Ebira (Latn, 2,200,000 speakers), Mango (Latn, 77,000 speakers). [code: soft-dotted]
