...
<details><summary>[14] NotoSansLaoLoopedUI[wdth,wght].ttf</summary>
<div>
<details>
...
* 🔥 **FAIL** <p>OS/2.usWinDescent value should be equal or greater than 433, but got 293 instead</p>
 [code: descent]
...
* 🔥 **FAIL** <p>Variable font instance name 'Noto Sans Lao Looped UI ExtraLight' formed by space-separated concatenation of font family name (nameID 1) and instance subfamily nameID 260 exceeds 32 characters.</p>
...
* 🔥 **FAIL** <p>Variable font instance name 'Noto Sans Lao Looped UI ExtraBold' formed by space-separated concatenation of font family name (nameID 1) and instance subfamily nameID 272 exceeds 32 characters.</p>
<p>This has been found to cause shaping issues for some accented letters in Microsoft Word on Windows 10 and 11.</p>
 [code: instance-too-long]
...
* ⚠️ **WARN** <p>Family metadata at fonts/NotoSansLaoLoopedUI/googlefonts/variable-ttf does not have an article.</p>
 [code: lacks-article]
...
<li>U+2010 HYPHEN: try adding one of: armenian, kharoshthi, kayah-li, yi, sundanese, hebrew, coptic, cham, arabic, lisu, syloti-nagri, sora-sompeng, kaithi</li>
...
<pre><code>* uni0EA5 (U+0EA5): X=397.5,Y=1.5 (should be at baseline 0?)

* uni0EC2 (U+0EC2): X=39.5,Y=713.5 (should be at cap-height 714?)

* uni0ECA (U+0ECA): X=119.0,Y=716.0 (should be at cap-height 714?)

* uni0ECA (U+0ECA): X=119.0,Y=712.0 (should be at cap-height 714?)

* uni0ECA.narrow: X=118.0,Y=716.0 (should be at cap-height 714?)

* uni0ECA.narrow: X=118.0,Y=712.0 (should be at cap-height 714?)

* uni0ECA.ss03: X=119.0,Y=716.0 (should be at cap-height 714?)

* uni0ECA.ss03: X=119.0,Y=712.0 (should be at cap-height 714?)

* uni0ED3 (U+0ED3): X=311.0,Y=2.0 (should be at baseline 0?)

* uni0ED4 (U+0ED4): X=313.5,Y=2.0 (should be at baseline 0?)

* uni0ED5 (U+0ED5): X=313.5,Y=2.0 (should be at baseline 0?)
...
* uni0EAA.BRACKET.varAlt01: X=400.0,Y=1.0 (should be at baseline 0?)
</code></pre>
