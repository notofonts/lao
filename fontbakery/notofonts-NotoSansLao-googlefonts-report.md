...
<details><summary><b>[9] NotoSansLao[wdth,wght].ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Version number has increased since previous release on Google Fonts? (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/version_bump">com.google.fonts/check/version_bump</a>)</summary><div>
 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: coptic, tai-le, canadian-aboriginal, old-permic, math, malayalam, syriac, tifinagh
 ...
 * U+200C ZERO WIDTH NON-JOINER: try adding one of: bengali, gunjala-gondi, meetei-mayek, tagalog, mandaic, siddham, brahmi, kharoshthi, javanese, mahajani, newa, hatran, tagbanwa, grantha, lepcha, tai-le, sogdian, mongolian, dogra, limbu, gujarati, saurashtra, sinhala, modi, kayah-li, khojki, syriac, tai-tham, thaana, tifinagh, tirhuta, buhid, devanagari, sundanese, new-tai-lue, rejang, balinese, thai, oriya, khmer, malayalam, nko, buginese, myanmar, psalter-pahlavi, tai-viet, telugu, kaithi, syloti-nagri, yi, chakma, phags-pa, batak, avestan, tamil, gurmukhi, cham, warang-citi, hanunoo, takri, hanifi-rohingya, duployan, pahawh-hmong, khudawadi, tibetan, manichaean, sharada, kannada
 * U+200D ZERO WIDTH JOINER: try adding one of: bengali, gunjala-gondi, emoji, meetei-mayek, tagalog, mandaic, siddham, brahmi, kharoshthi, javanese, mahajani, newa, tagbanwa, tai-le, grantha, lepcha, mongolian, dogra, limbu, gujarati, saurashtra, sinhala, modi, kayah-li, khojki, syriac, tai-tham, thaana, tifinagh, tirhuta, buhid, devanagari, sundanese, new-tai-lue, rejang, balinese, thai, old-hungarian, oriya, malayalam, nko, buginese, myanmar, psalter-pahlavi, tai-viet, telugu, kaithi, syloti-nagri, yi, chakma, phags-pa, batak, avestan, tamil, gurmukhi, cham, warang-citi, hanunoo, takri, hanifi-rohingya, duployan, pahawh-hmong, khudawadi, tibetan, manichaean, sharada, kannada
...
Your font does *not* cover the following languages that require the soft-dotted feature: Mundani (Latn, 34,000 speakers), Gulay (Latn, 250,478 speakers), Lugbara (Latn, 2,200,000 speakers), Aghem (Latn, 38,843 speakers), Southern Kisi (Latn, 360,000 speakers), Yala (Latn, 200,000 speakers), Ekpeye (Latn, 226,000 speakers), Sar (Latn, 500,000 speakers), Basaa (Latn, 332,940 speakers), Igbo (Latn, 27,823,640 speakers), Nzakara (Latn, 50,000 speakers), Ebira (Latn, 2,200,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Kom (Latn, 360,685 speakers), Avokaya (Latn, 100,000 speakers), Mango (Latn, 77,000 speakers), Cicipu (Latn, 44,000 speakers), Mfumte (Latn, 79,000 speakers), Navajo (Latn, 166,319 speakers), Dan (Latn, 1,099,244 speakers), Ma’di (Latn, 584,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Dii (Latn, 71,000 speakers), Koonzime (Latn, 40,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Bafut (Latn, 158,146 speakers), Ejagham (Latn, 120,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Zapotec (Latn, 490,000 speakers), Fur (Latn, 1,230,163 speakers), Nateni (Latn, 100,000 speakers), South Central Banda (Latn, 244,000 speakers), Makaa (Latn, 221,000 speakers). [code: soft-dotted]
